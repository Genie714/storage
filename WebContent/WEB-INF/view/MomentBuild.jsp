				...
				<div class="col-lg-8">
					...
					<div class="card text-center">
						<div class="card-body">
							...
							<h5 class="card-title">
								...
								<c:set var="moment"  value="${voteReponse1 }" />
              					...
              					<div class="tab-content pt-2" id="borderedTabContent">
									...
									<c:forEach var="selection" items="${voteReponse1 }">
										<li style="${selection.others == null ? 'display: none;' : 'display: inline;'}"> ${selection.others }</li>
									</c:forEach>
									</ul>	
									</div>
									</div>
							...
							<div id="result_date_name" class="card" >
							<div class="card-body">
								<h5 class="card-header">설문</h5>
							...
							<div id="result_place_name" class="card mb-3">
								...
								<div class="card-body">
									...
									<div class="tab-content pt-2" id="borderedTabContent" style="text-align: left;">
										...
										<div class="tab-pane fade" id="bordered-minETC" role="tabpanel" aria-labelledby="profile-tab">
											...
											<ul>
											<c:forEach var="selection" items="${voteReponse4 }">
												<li style="${selection.others == nulll ? 'display: none;' : 'display: inline;'}">${selection.others }</li>
											</c:forEach>
											</ul>
											</c:if>
										</div>
