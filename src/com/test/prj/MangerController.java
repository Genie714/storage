...
public class MangerController
{
	...
	*/
	...
	public String managerVoteFin(GroupMemberDTO dto, ManagerVoterDTO voter) 
	{	
		/*
	...
	/*
	@RequestMapping(value = "/managervotefin.action", method = RequestMethod.POST)
	public String managerVoteFin(@RequestParam("group_id") String group_id, 
            					 @RequestParam("vote_id") String vote_id, 
            					 @RequestParam("match_id") String match_id,
            					 @RequestParam("candidateMatchId") String selectedMatch_id)
	{
	    IManagerDAO dao = sqlSession.getMapper(IManagerDAO.class);
	    ...
	    voter.generateUniqueId();
	    voter.setVote_id(vote_id); 
	    voter.setVoter_id(match_id); 
	    voter.setSelected_id(dao.searchSelectedId(group_id, selectedMatch_id));
